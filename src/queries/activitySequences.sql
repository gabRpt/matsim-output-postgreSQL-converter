...
SELECT *, 
    CASE
        WHEN '00:00:00' <= start_time and '09:00:00' >= end_time then end_time - start_time
        WHEN '00:00:00' >= start_time and '09:00:00' >= end_time then end_time - '00:00:00'
        WHEN '00:00:00' > start_time and '09:00:00' < end_time then TIME '09:00:00' - TIME '00:00:00'
        WHEN '00:00:00' <= start_time and '09:00:00' <= end_time then '09:00:00' - start_time
...
and "personId" = 95254
order by activity_time_spent_in_interval desc