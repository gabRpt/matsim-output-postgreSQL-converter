...
* `pip install ./resources/setup/matsim_tools-1.0.5-py3-none-any.whl` or latest version available in [this folder](https://github.com/gabRpt/matsim-output-postgreSQL-converter/blob/main/resources/setup)
